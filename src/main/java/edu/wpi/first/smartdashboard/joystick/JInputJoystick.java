package edu.wpi.first.smartdashboard.joystick;
...
public class JInputJoystick {
  ...
  public JInputJoystick(int port) {
    initialize();
    this.controller = ControllerEnvironment.getDefaultEnvironment().getControllers()[port];
  }
   ...
   *
   * @param controllerType_1 Desired controller type.
   * @param controllerType_2 Another acceptable controller type.
   */
   ...
   * @see JInputJoystick#pollController()
   */
   ...
   * @see JInputJoystick#getXAxisValue()
   */
   ...
   * @see JInputJoystick#getXAxisPercentage()
   */
   ...
   * @see JInputJoystick#getYAxisValue()
   */
   ...
   * @see JInputJoystick#getYAxisPercentage()
   */
   ...
   * @see JInputJoystick#getZAxisValue()
   * @see JInputJoystick#getXRotationValue()
   */
   ...
   * @see JInputJoystick#getZAxisPercentage()
   * @see JInputJoystick#getXRotationPercentage()
   */
   ...
   * @see JInputJoystick#getZRotationValue()
   * @see JInputJoystick#getYRotationValue()
   */
   ...
   * @see JInputJoystick#getZRotationPercentage()
   * @see JInputJoystick#getYRotationPercentage()
   */
